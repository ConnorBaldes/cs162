...
Gold::Gold(const Gold& old_Gold) {

    this-> symbol = old_Gold.symbol;

    this-> percept = old_Gold.percept;
}
...
Gold& Gold::operator=(const Gold& old_Gold) {
...
void Gold::player_effect(Player& explorer, int i) {

    cout << "You found the treasure!" << endl;

    explorer.set_gold(true);
